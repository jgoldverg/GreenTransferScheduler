...
from scheduler_cli.scheduler_algo import Scheduler


class TestSchedulerAlgo:

    def test_init_defaults(self):
        test_obj = Scheduler("../../config/nodes_config.json", "../../config/trace_route_with_coordinates.json", "../../config/jobs.json")
